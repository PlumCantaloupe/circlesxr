...
function puzzlePictureAlreadySolved() { // Force set all counterObjects[i].isAtCorrectNumber to be true since puzzle is solved
    for (let i = 0; puzzlePictureObjects.length > i; i++) {
        puzzlePictureObjects[i].isInTheRequiredSpot = true;
