Interactions_Two Read Me: (Last update 01-22-2026)
...
Create 1 AFrame entity with the id “ScreenTextCombo” and set the default text to “Incorrect Code” (This can be changed). This text is made to inform users with a visual cue that they completed the puzzle.
...
Note: A quicker method to set up the Interaction is to go into the index file found in the Soical_Interactions world folder and copy and paste, lines 106  to 202. Doing this would only require changes to the AFrame entity (model, texture colour, ect).
