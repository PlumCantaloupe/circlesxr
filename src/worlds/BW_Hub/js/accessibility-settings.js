//component manages the accessibility controls
AFRAME.registerComponent('accessibility-controls', {
    init: function () {
        ...
        //initialize control panel selected buttons and instructions
        CONTEXT_AF.initButtons();
        ...
        CONTEXT_AF.prevScreen.addEventListener('click', function() {
            ...
            //if this is the first screen for the general instructions then display no graphics and only text
            if (CONTEXT_AF.contentArr === INSTRUCTIONS && CONTEXT_AF.currScreen === 0) {
                CONTEXT_AF.displayToggleInfoScreen(CONTEXT_AF.contentArr[0].text, CONTEXT_AF.contentArr[0].text2);
            }
            else {
                CONTEXT_AF.updateScreenContent(CONTEXT_AF.currScreen);
            }
        ...
        //listen for when the general instructions are selected
        ...
        //listen for when the mobile instructions are selected
        ...
        //listen for when desktop instructions are selected
        ...
        //listen for when headset instructions are selected
        ...
        //listen for when opaque teleport pads are selected
        CONTEXT_AF.opaqueTeleportPadSetting.addEventListener('click', function() {
            ...
            CONTEXT_AF.displayToggleInfoScreen(TELEPORT_PAD_INFO.OPAQUE.text, TELEPORT_PAD_INFO.OPAQUE.text2);

            CONTEXT_AF.prevScreen.setAttribute('circles-interactive-visible', 'false');
            CONTEXT_AF.nextScreen.setAttribute('circles-interactive-visible', 'false');
        })

        //listen for when transparent teleport pads are selected
        CONTEXT_AF.transparentTeleportPadSetting.addEventListener('click', function() {
            ...
            CONTEXT_AF.displayToggleInfoScreen(TELEPORT_PAD_INFO.TRANSPARENT.text, TELEPORT_PAD_INFO.TRANSPARENT.text2);

            CONTEXT_AF.prevScreen.setAttribute('circles-interactive-visible', 'false');
            CONTEXT_AF.nextScreen.setAttribute('circles-interactive-visible', 'false');
        })

        //listen for when glow is turned on
        CONTEXT_AF.bloomOnSetting.addEventListener('click', function(){
            ...
            CONTEXT_AF.displayToggleInfoScreen(BLOOM_INFO.ON.text, BLOOM_INFO.ON.text2);
        ...
        //listen for when glow is turned off
        CONTEXT_AF.bloomOffSetting.addEventListener('click', function(){
            ...
            CONTEXT_AF.displayToggleInfoScreen(BLOOM_INFO.OFF.text, BLOOM_INFO.OFF.text2);

            CONTEXT_AF.prevScreen.setAttribute('circles-interactive-visible', 'false');
            CONTEXT_AF.nextScreen.setAttribute('circles-interactive-visible', 'false');
        })

        //listen for when guiding text is turned on
        CONTEXT_AF.guidingTextOnSetting.addEventListener('click', function(){
            ...
            CONTEXT_AF.displayToggleInfoScreen(GUIDING_TEXT_INFO.ON.text, GUIDING_TEXT_INFO.ON.text2);

            CONTEXT_AF.prevScreen.setAttribute('circles-interactive-visible', 'false');
            CONTEXT_AF.nextScreen.setAttribute('circles-interactive-visible', 'false');
        })

        //listen for when guiding text is turned off
        CONTEXT_AF.guidingTextOffSetting.addEventListener('click', function(){
            ...
            CONTEXT_AF.displayToggleInfoScreen(GUIDING_TEXT_INFO.OFF.text, GUIDING_TEXT_INFO.OFF.text2);
    ...
    //init the properly selected buttons on init to indicate the selected configs
    initButtons: function() {
        const CONTEXT_AF = this;
        
        //get saved teleport data from the shared state and indicate it with the toggle buttons
        ...
        //get saved bloom data from the shared state and indicate it with the toggle buttons
        ...
        //get saved guiding text data from the shared state and indicate it with the toggle buttons
        ...
        //update screen content to display the device instructions
        CONTEXT_AF.updateScreenContent(CONTEXT_AF.currScreen);
    },
    ...
    toggleButton: function(select, deselect) {
        ...
        //deselect and reset its toggle partner
    ...
    displayToggleInfoScreen: function(text1, text2) {
        const CONTEXT_AF = this;
        CONTEXT_AF.textScreenContent(CONTEXT_AF.screenText, text1, 0.151);
        CONTEXT_AF.screenText2.setAttribute('circles-interactive-visible', 'true');
        CONTEXT_AF.textScreenContent(CONTEXT_AF.screenText2, text2,-0.116);
