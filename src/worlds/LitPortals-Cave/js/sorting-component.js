AFRAME.registerComponent('sorting-collision', {
    ...
    resetSorting: function() {
        setTimeout(() => {
            document.getElementById("vaseSort").object3D.position.set(12.5, 2.3, -15.1);
            document.getElementById("sculptureSort").object3D.position.set(12.5, 2, -14.3);
            document.getElementById("figurineSort").object3D.position.set(12.5, 1.95, -13.3);
            document.getElementById("sculpture2Sort").object3D.position.set(12.5, 1.75, -12.5);
