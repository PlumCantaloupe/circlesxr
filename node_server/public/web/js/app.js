...
function copyMagicLinks(url) {

  console.log('COPYING TEXT!!!');

  //copy text functionality from here: https://stackoverflow.com/questions/400212/how-do-i-copy-to-the-clipboard-in-javascript 
  ...
  textArea.value = 'lorum ipsum something something ' + url;
